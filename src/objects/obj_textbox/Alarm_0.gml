...
if array_length(effects_p) != undefined
effects_al		= array_length(effects_p)/2;
else
effects_al = 0;
...
if(type[page] == 0){
	...
	var next_space = 0, char, txtwidth = boxWidth-(x_buffer), char_max = txtwidth div charSize;
	...
	repeat(str_len){
		...
		if(cc >= next_space){
			...
			var linewidth = (next_space-breakpoint)*5.5;
