...
boxWidth		= sprite_get_width(dialogue_box) * scale - 20;
gui_width		= display_get_gui_width();
gui_height		= display_get_gui_height();
gb_diff			= gui_width - boxWidth + 20;
portraitWidth	= 0;//sprite_get_width(portrait_frame) * scale;
...
name_box_x		= pos_x+3;
name_box_y		= pos_y - (13 * scale);
name_box_text_x = name_box_x + 10;
name_box_text_y = name_box_y + y_buffer - 2;
