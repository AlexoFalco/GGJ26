...
function CheckSolid() {
	...
	var _coll = collision_circle_list(x, y, 320, obj_collider, true, false, _list, false);
	var _coll2 = collision_circle_list(x, y, 320, obj_player_mad, true, false, _list, false);
